            ...
            <div className = "post-container">
                ...
                <div className="form-inner">
                    ...
                    <div className="input-holder">
                        ...
                        <input className="input-text" type="text" id="category"onChange={this.handleChange}/>
                     
                    </div>  
                        
                    <div className = "input-holder">
                        <span className="label"> Write new post:</span>  
                        <textarea className="input-text" value={this.state.value} type="text" id="newPost" onChange={this.handleChange}></textarea> 
